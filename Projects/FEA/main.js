...
const prepareRHSVector = (mat, vec) => {
...
const JacobiSolver = (initialGuess, mat, rhs, iterations) => {
    if (mat.length !== mat[0].length) {
        throw new Error("Matrix must be square");
    }
